...
namespace Plugin.BLE.Abstractions
{
    public abstract class AdapterBase : IAdapter
    {
        ...
        public event EventHandler<DeviceEventArgs> DeviceConnectedBluetooth;
        ...
        public void HandleConnectedDeviceBluetooth(IDevice device)
        {
            DeviceConnectedBluetooth(this, new DeviceEventArgs { Device = device });
        }
        ...
        protected abstract Task<string> GetResponseFromSocketNativeAsync(string request);
        ...
        public async Task<string> GetResponseFromSocketAsync(string request)
        {
            return await GetResponseFromSocketNativeAsync(request);
        }
    }
}